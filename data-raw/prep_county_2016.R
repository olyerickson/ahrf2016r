...
url = "http://datawarehouse.hrsa.gov/DataDownload/AHRF/AHRF_2015-2016.zip"
fil_zip = tempfile(fileext = ".zip")

# If we've already done the extraction, don't repeat it!
...
# These filenames are slightly different than 2014-2015
raw_src = "county/ahrf2016.asc" # Raw data
dic_src = "county/ahrf2016.sas" # SAS dictionary file

# Prepare layout file -----------------------------------------------------
# Read in the structure as defined in the .sas file
...
save(ahrf_county_layout, file="data/ahrf_county_layout.rda")
save(ahrf_county, file="data/ahrf_county.rda")
